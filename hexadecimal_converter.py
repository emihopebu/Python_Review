...
print("\nUsing slices, we will know show a portion of each list.")
lower_range=int(input("What decimal number would like to start at: "))
upper_range=int(input("What decimal number would like to stop at: "))
