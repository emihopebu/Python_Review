...
print("Your favorite teachers in reverse alphabetically are: "+str(sorted(fav_teachers, reverse=True)))
...
fav_teachers.remove(input("You have decided you no longer like a teacher. Which teacher would you like to remove from your list: ").title())
#Summary of list
print("\nYour favorite teachers ranked are: "+str(fav_teachers))
print("Your favorite teachers alphabetically are: "+str(sorted(fav_teachers)))
print("Your favorite teachers in reverse alphabetically are: "+str(sorted(fav_teachers, reverse=True)))
